...
export function ConditionNode({ data }: NodeProps) {
  return (
    <div className="flex h-16 w-32 items-center justify-center" style={{ transform: "rotate(45deg)" }}>
      <div
        className="flex h-full w-full items-center justify-center border border-purple-400 bg-white shadow"
        style={{ clipPath: "polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)" }}
      >
        <span className="text-xs font-medium" style={{ transform: "rotate(-45deg)" }}>
